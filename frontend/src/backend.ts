...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: Array<string>, arg5: bigint, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async checkout(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: Array<string>, arg6: bigint, arg7: string): Promise<void> {
        if (this.processError) {
            try {
